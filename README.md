...
<p>Update: Still getting the ouput of the slicer to get turned into GCode.</p>
<p>Update 2: Actually have the slicer working now. Original code had a really stupid flaw that I finally uncovered today. Now I can make some constructive progress.</p>
