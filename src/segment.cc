...
Vertex
Segment::intersect_with_plane(const float& z) const
{
	Vertex p0 = v0;
	Vertex slope = v1 - v0;
	Vertex v;
...
float
Segment::distance(const Vertex &v3) const
{
	Vertex slope = v1 - v0;
...
bool
Segment::intersect_with_segment(const Segment& s2, Vertex &intersection) const
{
